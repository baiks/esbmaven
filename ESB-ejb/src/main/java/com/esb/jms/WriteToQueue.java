...
public class WriteToQueue {
    ...
    public boolean writeToRequestQueue(String queueName, String PROVIDER_URL, String SECURITY_PRINCIPAL, String SECURITY_CREDENTIALS, String JMS_FACTORY, String dataMap) {
